...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.PlaceViewHolder> {
    ...
    private static SearchAdapter.ItemClickListener mClickListener;
    ...
    public static class PlaceViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public PlaceViewHolder(View view) {
            ...
            mImageView = (ImageView) view.findViewById(R.id.fragment_search_recycler_view_item_image);
            mName = (TextView) view.findViewById(R.id.fragment_search_recycler_view_item_place_name);
            mAddress = (TextView) view.findViewById(R.id.fragment_search_recycler_view_item_place_address);
            mLastVisitDate = (TextView) view.findViewById(R.id.fragment_search_recycler_view_item_last_visit_date);
            mHitCount = (TextView) view.findViewById(R.id.fragment_search_recycler_view_item_hit_count);

            mTransportModeImage = (ImageView) view.findViewById(R.id.fragment_search_recycler_view_item_transition_mode_image);
            mMoreMenuImage = (ImageView) view.findViewById(R.id.fragment_search_recycler_view_item_more_image);
    ...
    public SearchAdapter(Context context, List<DirectionItem> items) {
    ...
    @NonNull
    @Override
    public SearchAdapter.PlaceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_search_recycler_view_item, parent, false);
        return new SearchAdapter.PlaceViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull SearchAdapter.PlaceViewHolder holder, int position) {
...
*/
    ...
    public void setOnItemClickListener(SearchAdapter.ItemClickListener clickListener) {
